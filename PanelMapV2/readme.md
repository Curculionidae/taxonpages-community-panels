...
This panel is a standalone-clone of the vanilla TaxonPages map panel, branched from the state of the codebase on **2026-03-21**. It is a drop-in replacement 
